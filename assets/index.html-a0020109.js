...
const _hoisted_1 = /* @__PURE__ */ createBaseVNode(
  ...
  [
    ...
    /* @__PURE__ */ createTextVNode(" Python Strings")
  ],
  -1
  /* HOISTED */
);
...
const _hoisted_4 = /* @__PURE__ */ createStaticVNode('<h2 id="lecture-material" tabindex="-1"><a class="header-anchor" href="#lecture-material" aria-hidden="true">#</a> Lecture material</h2><ul><li><a href="python-strings.pdf">python-strings.pdf</a></li><li><a href="python-strings.pptx">python-strings.pptx</a></li></ul><h2 id="recommended-reading" tabindex="-1"><a class="header-anchor" href="#recommended-reading" aria-hidden="true">#</a> Recommended reading</h2>', 3);
const _hoisted_7 = {
