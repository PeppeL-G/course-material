# Lectures
The instructions on the [Project Work](project-work/) page and the [Laboratory Work](laboratory-work/) page indicate when you're expected to view which lectures, but here's a list of all of them.
